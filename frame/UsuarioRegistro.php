...
<body>
	...
	<div id="menu">
		...
		<p><iframe frameborder="0" src="../frame/lateral2.php" 
			style="border: 0px solid black;" scrolling="no" width="100%" 
			height="900">Tu navegador no permite iframes</iframe></p>
	</div>
	
	<div id="contenido">
		<iframe frameborder="0" src="../usuarios/UserRegistro.php" 
		style="border: 0px solid black;" scrolling="no" width="150%" 
		height="1000">Tu navegador no permite iframes</iframe>
	</div>	
